                                            ...
                                            <div class="card-body">
                                                <form class="form-horizontal">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 form-control-label">payment id</label>
                                                        <div class="col-sm-9">
                                                            <input id="payment_id" type="text"	placeholder="payment id" class="form-control form-control-warning">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="payment_type" type="text"	placeholder="payment type" class="form-control form-control-warning">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">

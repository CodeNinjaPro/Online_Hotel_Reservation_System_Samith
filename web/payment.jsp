                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 form-control-label">Reservations</label>
                                                        <div class="col-sm-9">
                                                            <select id="reservation_id" class="form-control form-control-warning">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="loyalty" type="number"	value="0" class="form-control form-control-warning" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 form-control-label">Values for Points</label>
                                                        <div class="col-sm-9">
                                                            <input id="offer_loyalty" type="number"	value="0" class="form-control form-control-warning" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 form-control-label">Payment Type</label>
                                                        <div class="col-sm-9">
                                                            <select id="payment_type" class="form-control form-control-warning">
                                                                <option>Cash</option>

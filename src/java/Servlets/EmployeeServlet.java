		...
		if (action.equals("insert")) {
			...
			try {
				...
				for (int i = 0; i < list.size(); i++) {
					String s = list.get(i).getEmployee_id() + "_"+list.get(i).getFull_name() + "_"+list.get(i).getAddress() + "_"+list.get(i).getNic() + "_"+list.get(i).getContact() + "_"+list.get(i).getEmail() + "_"+list.get(i).getDesignation() + "_"+list.get(i).getDate_time() + "_";
					stringList.add(s);
				}
